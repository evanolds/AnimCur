...
internal class EOANIWriter
{
    ...
    public bool WriteFrame32(System.Drawing.Bitmap BMFrame)
    {
        if (BMFrame.PixelFormat != System.Drawing.Imaging.PixelFormat.Format32bppArgb &&
            BMFrame.PixelFormat != System.Drawing.Imaging.PixelFormat.Format32bppRgb)
        {
            return false;
        }
        ...
        EOIcoCurWriter writer = new EOIcoCurWriter(
            m_writer.BaseStream, 1, EOIcoCurWriter.IcoCurType.Cursor);
        writer.WriteBitmap(BMFrame, BMFrame, HotSpot);
